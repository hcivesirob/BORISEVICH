...
namespace BORISEVICH.Tests
{
    public class ProductControllerTests
    {
        ...
        void SetupData()
        {
            ...
            {
                new Category {Id=1, Name="Повесть", NormalizedName="story"},
                new Category {Id=2, Name="Роман", NormalizedName="novel"},
                new Category {Id=3, Name="Детектив", NormalizedName="detective"},
            ...
            var productResponse = new ResponseData<ProductListModel<Book>>();
            productResponse.Data = new ProductListModel<Book> { Items = books };
